...
RUN wget -O bind-${BIND_VERSION}.tar.xz https://github.com/jtaeyeon05/bind9-ruc-patch/releases/download/v9.20.3-patch2/bind-${BIND_VERSION}.tar.xz && \
